...
|---|---|
| 📚 **Module A–Z** | **26 Ausbildungsmodule (A bis Z)** mit **114 Lektionen** – von Rechtsgrundlagen, Brandlehre, Atemschutz und Gefahrgut über Maschinist, Baukunde und Führung (FwDV 100) bis zu Rettung, Wasserversorgung, Knoten, Vegetationsbrand, Naturgefahren, Wasserrettung, Motorsäge und Katastrophenschutz |
| 🎯 **Personalisiert** | Adaptive Lernempfehlung, individueller Lernpfad je nach Ausbildungsniveau, Fortschritts-Tracking |
| 📝 **Prüfungen** | **629 Prüfungsfragen** in drei Stufen (Grundlagen · Aufbau · Prüfung) mit sofortiger Auswertung, Erklärungen und Leistungsnachweisen |
