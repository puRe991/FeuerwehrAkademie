...
| 🏅 **Erfolge / Abzeichen** | 22 freischaltbare Abzeichen (Lernen · Prüfungen · Fragen · Praxis · Gewohnheit) auf einem hochwertigen Feuerwehr-Orden-Design mit Fortschrittsanzeige – einmal verdient, bleiben sie erhalten; neue schalten sich mit Konfetti frei |
| 📈 **Statistik** | Persönliche Auswertung aus den getrackten Daten: Prüfungs-Score-Verlauf (Linie mit Bestehensgrenze), Beherrschung je Kategorie (Balken), Aktivitäts-Heatmap (13 Wochen) sowie Stärken & Schwachstellen – alles als offline-fähiges, theme-aware Inline-SVG |
