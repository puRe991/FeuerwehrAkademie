...
export const UNFALL_CATS = {
  ...
  belastung:       { label: 'Körperliche Belastung & Kreislauf', color: '#16a085', icon: 'heart' },
...
{
  id: 'lb-2026-homburg',
  jahr: 2026, datum: '2026-01-07', datumText: '7. Januar 2026',
  ort: 'Homburg', land: 'Saarland',
  titel: 'Extreme Hitze bei einem Kellerbrand',
  cat: 'durchzuendung',
  kurz: 'Bei einem Kellerbrand in einem Mehrfamilienhaus entwickelte sich extreme Hitze; ein Feuerwehrangehöriger erlitt leichte Verbrennungen.',
  hergang: 'Im Innenangriff auf den Kellerbrand staute sich die Wärme in den engen, schlecht zu entrauchenden Räumen. Ein Atemschutzgeräteträger zog sich dabei leichte Verbrennungen zu.',
  verletzung: 'Ein Feuerwehrangehöriger: leichte Verbrennungen.',
  lehren: [
    'Keller sind Wärmefallen: kein natürlicher Abzug, lange Wege und schnelle Temperaturanstiege.',
    'Rauchgaskühlung mit kurzen Impulsen, Rückzugsweg und Wasser am Rohr sichern das Vorgehen ab.',
    'Angriffszeit begrenzen und die Belastung durch Hitze bewusst überwachen.',
  ],
  module: ['f-atemschutz', 'b-brennen-loeschen', 'e-loescheinsatz'],
  quelleUrl: 'https://www.atemschutzunfaelle.de/unfaelle/de/2026/u20260107-homburg.html',
  quelleName: 'atemschutzunfaelle.de',
},
{
  id: 'lb-2026-helmstedt',
  jahr: 2026, datum: '2026-01-15', datumText: '15. Januar 2026',
  ort: 'Helmstedt', land: 'Niedersachsen',
  titel: 'Durchzündung bei einem Dachstuhlbrand',
  cat: 'durchzuendung',
  kurz: 'Bei einem Wohnungs- und Dachstuhlbrand kam es zu einer Durchzündung; ein Feuerwehrangehöriger wurde leicht verletzt.',
  hergang: 'Der Brand hatte auf den Dachstuhl übergegriffen. Angesammelte Rauchgase durchzündeten schlagartig; ein Einsatzkräfte wurde dabei leicht verletzt.',
  verletzung: 'Ein Feuerwehrangehöriger: leichte Verletzung.',
  lehren: [
    'Dachräume sammeln große Mengen zündfähiger Rauchgase – Durchzündungsgefahr auch abseits des Brandherds.',
    'Öffnungen kontrolliert und aus der Deckung schaffen, Rauchgase vorher kühlen.',
    'Rauchschicht und Strömung ständig beobachten; Warnzeichen ernst nehmen.',
  ],
  module: ['b-brennen-loeschen', 'f-atemschutz', 'o-baukunde'],
  quelleUrl: 'https://www.atemschutzunfaelle.de/unfaelle/de/2026/u20260115-helmstedt.html',
  quelleName: 'atemschutzunfaelle.de',
},
{
  id: 'lb-2026-goslar',
  jahr: 2026, datum: '2026-06-20', datumText: '20. Juni 2026',
  ort: 'Goslar', land: 'Niedersachsen',
  titel: 'Kreislaufkollaps nach der Atemschutz-Ausbildung',
  cat: 'belastung',
  kurz: 'Nach einer Atemschutzgeräteträger-Ausbildung kollabierte ein Lehrgangsteilnehmer mit Kreislaufproblemen.',
  hergang: 'Die körperlich sehr fordernde Ausbildung unter Atemschutz führte bei einem Teilnehmer im Anschluss zu einem Kreislaufkollaps.',
  verletzung: 'Ein Lehrgangsteilnehmer: Kreislaufproblem/Kollaps.',
  lehren: [
    'Atemschutz ist Hochleistungssport – Tauglichkeit, Belastungsgrenzen und Erholungsphasen ernst nehmen.',
    'Ausreichend trinken, Pausen und eine geregelte Nachbereitung (Rehab) gehören zur Ausbildung dazu.',
    'Auch bei Übungen sanitätsdienstliche Überwachung und schnelle Hilfe bereithalten.',
  ],
  module: ['f-atemschutz', 'p-arbeitsschutz', 'j-erste-hilfe'],
  quelleUrl: 'https://www.atemschutzunfaelle.de/unfaelle/de/2026/u20260620-goslar.html',
  quelleName: 'atemschutzunfaelle.de',
},
{
  id: 'lb-2026-welgesheim',
  jahr: 2026, datum: '2026-06-20', datumText: '20. Juni 2026',
  ort: 'Welgesheim', land: 'Rheinland-Pfalz',
  titel: 'Zahlreiche Kreislaufprobleme bei langem Löscheinsatz',
  cat: 'belastung',
  kurz: 'Bei einem Lagerhallenbrand mit rund 100 Tonnen Gewerberestmüll klagten 13 Einsatzkräfte über Kreislaufprobleme; neun kamen ins Krankenhaus.',
  hergang: 'Der ausgedehnte, lang andauernde Löscheinsatz bei Hitze und hoher körperlicher Belastung überforderte zahlreiche Kräfte; viele mussten wegen Kreislaufproblemen behandelt werden.',
  verletzung: '13 Einsatzkräfte: Kreislaufprobleme, davon neun mit Krankenhausbehandlung.',
  lehren: [
    'Langdauernde Einsätze verlangen frühzeitige, großzügige Alarmierung und geplante Ablösung der Kräfte.',
    'Verpflegung, Getränke und ein eingerichteter Rehab-/Betreuungsbereich beugen Ausfällen vor.',
    'Hitze und Dauerbelastung als eigene Gefahr in die Einsatzplanung aufnehmen, nicht erst reagieren.',
  ],
  module: ['l-fuehrung-fwdv100', 'p-arbeitsschutz', 'f-atemschutz'],
  quelleUrl: 'https://www.atemschutzunfaelle.de/unfaelle/de/2026/u20260620-welgesheim.html',
  quelleName: 'atemschutzunfaelle.de',
},
{
  id: 'lb-2026-ratingen',
  jahr: 2026, datum: '2026-06-21', datumText: '21. Juni 2026',
  ort: 'Ratingen', land: 'Nordrhein-Westfalen',
  titel: 'Durchzündung beim Öffnen der Dachluke',
  cat: 'durchzuendung',
  kurz: 'Bei einem Dachstuhlbrand durchzündeten die Rauchgase beim Öffnen der Zugangsklappe; ein Feuerwehrangehöriger erlitt Verbrennungen an den Handgelenken.',
  hergang: 'Beim Öffnen der Zugangsklappe zum Dachraum strömte Luft an die heißen, angesammelten Rauchgase – es kam zur Durchzündung. Ein Einsatzkräfte wurde an den Handgelenken verbrannt.',
  verletzung: 'Ein Feuerwehrangehöriger: Verbrennungen an den Handgelenken.',
  lehren: [
    'Jede Öffnung liefert die fehlende Luft: Türen und Klappen kontrolliert, seitlich und aus der Deckung öffnen.',
    'Rauchgase vor dem Öffnen kühlen und die Reaktion abwarten, statt sofort nachzudrängen.',
    'Übergänge zwischen Schutzkleidung (Handgelenke, Hals) sind Schwachstellen – Körperhaltung bewusst wählen.',
  ],
  module: ['b-brennen-loeschen', 'f-atemschutz', 'd-geraetekunde'],
  quelleUrl: 'https://www.atemschutzunfaelle.de/unfaelle/de/2026/u20260621-ratingen.html',
  quelleName: 'atemschutzunfaelle.de',
},
{
  id: 'lb-2026-bentwisch',
  jahr: 2026, datum: '2026-07-05', datumText: '5. Juli 2026',
  ort: 'Bentwisch', land: 'Mecklenburg-Vorpommern',
  titel: 'Explosion eines PV-Batteriespeichers',
  cat: 'elektro',
  kurz: 'Bei einem Schuppenbrand explodierte ein Photovoltaik-Batteriespeicher; drei Feuerwehrangehörige (zwei davon Atemschutzgeräteträger) wurden leicht verletzt.',
  hergang: 'Im Brandverlauf geriet ein PV-Batteriespeicher in thermisches Durchgehen und explodierte. Druckwelle bzw. herausgeschleuderte Teile verletzten drei Kräfte leicht.',
  verletzung: 'Drei Feuerwehrangehörige leicht verletzt, davon zwei Atemschutzgeräteträger.',
  lehren: [
    'Lithium-Ionen-Speicher können explodieren und sich rückzünden – ausreichend Abstand halten, geschlossene Räume mit Speicher meiden.',
    'PV-Anlagen stehen bei Tageslicht unter Spannung und lassen sich nicht einfach freischalten.',
    'Viel Wasser zur Kühlung, langer Beobachtungszeitraum und klare Absperrung des Gefahrenbereichs.',
  ],
  module: ['p-arbeitsschutz', 'b-brennen-loeschen', 'm-vorbeugender-brandschutz'],
  quelleUrl: 'https://www.atemschutzunfaelle.de/unfaelle/de/2026/u20260705-bentwisch.html',
  quelleName: 'atemschutzunfaelle.de',
},
{
  id: 'lb-2026-dresden',
  jahr: 2026, datum: '2026-07-14', datumText: '14. Juli 2026',
  ort: 'Dresden', land: 'Sachsen',
  titel: 'Notfall unter Atemschutz bei einem Wohnungsbrand',
  cat: 'atemschutznotfall',
  kurz: 'Bei einem Wohnungsbrand kam es während der Löscharbeiten zu einem Vorfall unter Atemschutz; ein Feuerwehrangehöriger wurde ins Krankenhaus gebracht.',
  hergang: 'Während des Innenangriffs geriet ein Atemschutzgeräteträger in einen Notfall und musste aus dem Gefahrenbereich gebracht und in ein Krankenhaus transportiert werden (Einzelheiten siehe Quelle).',
  verletzung: 'Ein Feuerwehrangehöriger: ins Krankenhaus transportiert (Art der Verletzung unklar).',
  lehren: [
    'Atemschutzüberwachung und ein einsatzbereiter Sicherheitstrupp müssen jederzeit greifen.',
    'Ein geübtes Mayday-/Notfallschema entscheidet über die Zeit bis zur Rettung des Trupps.',
    'Luftvorrat und Anzeichen von Erschöpfung konsequent im Blick behalten – rechtzeitig zurückziehen.',
  ],
  module: ['f-atemschutz', 'l-fuehrung-fwdv100', 'j-erste-hilfe'],
  quelleUrl: 'https://www.atemschutzunfaelle.de/unfaelle/de/2026/u20260714-dresden.html',
  quelleName: 'atemschutzunfaelle.de',
},
