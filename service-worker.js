...
const ASSETS = [
  ...
  './assets/js/data/content/z-katastrophenschutz.js',
  './assets/js/data/content/y-motorsaege.js',
  './assets/js/data/content/x-wasserrettung.js',
  './assets/js/data/content/w-naturgefahren.js',
  './assets/js/data/content/v-vegetationsbrand.js',
  './assets/js/data/content/u-knoten.js',
  './assets/js/data/content/t-wasserversorgung.js',
  './assets/js/data/content/s-rettung.js',
  './assets/js/data/content/r-digital.js',
  './assets/js/data/content/q-jugend.js',
  './assets/js/data/content/p-arbeitsschutz.js',
  './assets/js/data/content/o-baukunde.js',
  './assets/js/data/content/m-vorbeugender-brandschutz.js',
  './assets/js/data/content/k-absturzsicherung.js',
  './assets/js/data/content/n-maschinist.js',
  './assets/js/data/content/c-fahrzeugkunde.js',
